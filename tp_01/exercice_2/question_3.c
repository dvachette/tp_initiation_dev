...
int main(){
    ...
    printf("est_date_valide(%d) = %d\n", date0, est_date_valide(date0)); // Affichage du resultat dans la console
    printf("est_date_valide(%d) = %d\n", date1, est_date_valide(date1)); // Affichage du resultat dans la console
    printf("est_date_valide(%d) = %d\n", date2, est_date_valide(date2)); // Affichage du resultat dans la console
